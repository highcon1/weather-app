...
const SplashScreen = () => {
  return (
    <div className='w-screen h-screen bg-black text-white flex flex-col justify-around items-center gap-6 mb-[20em]'>
        <Umbrella color='blue' size={250} style={{ transform: "rotate(20deg)", strokeWidth: "0.5"}} />
        <div>
          <h1 className='font-bold text-[50px] leading-7 tracking-wider'>Breeze</h1>
